...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_1xmomqvy {
        ...
        private FastObjectFactory_app_web_1xmomqvy() {
        }
        ...
        static object Create_ASP_order_aspx() {
            return new ASP.order_aspx();
        }
